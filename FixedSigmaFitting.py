...
def get_rotational_spectrum(B, delta_B, zeta, T, origin):
    ...
    '''Takes in parameters (molecular and environmental) 
...
def get_multi_spectra( **params_list):
    ...
    first_origin_index = last_T_index  
    ...
    for T,  origin, sightline in zip(T_values, origin_values, sightlines):
...
sigma = 0.16
#result = fit_model(B = 0.002, delta_B = -0.1, zeta = -0.312, T = 93.6, origin =  0.014)
