...
for sightline in sightlines : 
    velocity1, flux1  = plot_K_and_CHplus_line(wave = 4232, rest_wave = 4232.548, sightline= sightline,
    ...
    velocity2, flux2  = plot_K_and_CHplus_line(wave = 7698, rest_wave = 7698.965, sightline= sightline,
                                             plotrange=(7698.1, 7699.9), 
                                   conitnuum_range_before = (7698.1, 7698.5),
                                    conitnuum_range_after = (7699.4, 7699.9))


    plt.plot(velocity1, flux1, label = 'CH+')
    plt.plot(velocity2, flux2, label = 'K')
    plt.title(sightline)
    plt.xlim(-10, 10)
    plt.legend()
    plt.show()